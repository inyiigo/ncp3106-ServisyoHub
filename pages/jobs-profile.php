...
<head>
    ...
    <title>Jobs • Profile • Servisyo Hub</title>
    ...
    .profile-bg { background: #ffffff !important; }
    </style>
</head>
<body class="theme-profile-bg">
    ...
    <div class="profile-bg">
        <div class="prof-container">
            ...
            <!-- Worker menu list -->
            <nav class="prof-menu" aria-label="Worker profile options">
                <a class="prof-item" href="./my-jobs.php">
                ...
                <a class="prof-item" href="./jobs-profile.php?logout=1">
    ...
    <nav class="dash-bottom-nav">
        ...
        <a href="./jobs-profile.php" class="active" aria-label="Profile">
