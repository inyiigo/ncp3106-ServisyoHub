...
<body class="theme-profile-bg">
	...
	<!-- Top bar with boxed back button on the right -->
	<div class="dash-topbar" style="display:flex; align-items:center; justify-content:flex-end; border-bottom:3px solid #0078a6; padding:8px 16px 0 16px; background:transparent;">
		<a href="./home-gawain.php" class="back-box" title="Back" style="display:inline-flex; align-items:center; gap:6px; padding:8px 16px; border-radius:10px; background:#0078a6; color:#fff; font-weight:800; border:2px solid color-mix(in srgb, #0078a6 80%, #0000); box-shadow:0 6px 18px rgba(0,120,166,.18); text-decoration:none; font-size:1.2rem;">
			&lt;
		</a>
	</div>
		...
		<div class="prof-container">
			...
			<section class="prof-tabs" aria-label="Profile sections">
				<div class="tabbar" role="tablist" aria-label="Profile tabs">
					<button type="button" class="tab-link active" data-tab="reviews" role="tab" aria-selected="true" aria-controls="tab-reviews">Reviews</button>
				...
				<div class="tab-panels">
					...
					<div id="tab-reviews" class="tab-panel" role="tabpanel">
						...
						<div id="revKasanggaPanel" class="review-panel" role="tabpanel">
							<p class="review-empty">Don't have any reviews yet. </p>
							<!-- ...existing code... -->
						</div>
